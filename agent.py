...
# آپ کی پروفائل کا ڈیٹا جو جیمنائی ہمیشہ یاد رکھے گا
SARFRAZ_PROFILE = """
...
def check_job_with_gemini(job_title, job_description):
    ...
    Task:
    Determine if this job is a 100% match for Sarfraz's experience in Heavy Truck Driving (specifically Container, Flatbed, or Curtain-side trailers).
